    ...
    <section id="title_section">
        <div class="container">
            ...
            @foreach($paquete as $paquetes)
                <div class="col-12 col-sm-12 col-md-4 d-flex mb-3">
...
{{--                            <!--                        </span>-->--}}
                            ...
                            <small class="text-white">lima</small>
...
{{--                    <!--            </div>-->--}}
                    <div class="card-footer bg-white">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <p class="font-weight-bold text-primary h5 m-0"><sup class="small"><small>desde</small></sup> $19<small>USD</small></p>
