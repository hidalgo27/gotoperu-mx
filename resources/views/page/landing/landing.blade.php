...
@section('content')
    ...
    <section class="m-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <h3 class="h5 text-center">APLAZAMIENTO LIBRE</h3>
                    <p class="text">
                ...
                <div class="col">
                    <h3 class="h5 text-center">TOURS PRIVADOS</h3>
                    <p class="text">
                ...
                <div class="col">
                    <h3 class="h5 text-center">FECHAS FLEXIBLES</h3>
                    <p class="text">
                ...
                <div class="col">
                    <h3 class="h5 text-center">SIN INFLACIONES</h3>
                    <p class="text">
